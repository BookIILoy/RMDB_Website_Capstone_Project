...
function MostPopularMoviesPage() {
  ...
  useEffect(() => {
    async function fetchMovies() {
      try {
        const response = await fetch(`${baseUrl}?api_key=${apiKey}&sort_by=popularity.desc&page=${page}`);
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gray-800">
      ...
      <h1 className="text-4xl font-bold mb-8 text-white">Most Popular Movies</h1>
