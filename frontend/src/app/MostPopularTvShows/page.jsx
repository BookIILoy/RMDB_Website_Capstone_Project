...
function MostPopularTvShowsPage() {
  ...
  // Calculate the starting number of each TV show across pages
  const startingNumber = (page - 1) * 20;

  // Generate page numbers based on the current page and scope visible buttons
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gray-800">
      ...
      <h1 className="text-4xl font-bold mb-8 text-white">Most Popular TV Shows</h1>
...
export default MostPopularTvShowsPage;
